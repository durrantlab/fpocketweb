...
let computedFunctions = {
    /** Gets and sets the fpocketParams object. In setting, also makes sure that
     * the value meets min/max requirements, etc.*/
    "val": {
        get(): any {
            return this.$store.state["fpocketParams"][this["id"]];
        },
        ...
        set(val: any): void {
            ...
            let valid = true;
            let scoreOnly = this.$store.state["fpocketParams"]["score_only"];
